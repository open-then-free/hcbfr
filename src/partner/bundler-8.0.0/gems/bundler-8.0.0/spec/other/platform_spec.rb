...
G
  ...
  context "bundle cache" do
    ...
    it "copies the .gem file to ../../.gem/cache when ruby version matches" do
      gemfile <<-G
        gem 'rack'
    ...
    it "copies the .gem file to ../../.gem/cache when ruby version matches for any engine" do
      simulate_ruby_engine "jruby" do
        gemfile <<-G
          gem 'rack'
  ...
  context "bundle pack" do
    ...
    it "copies the .gem file to ../../.gem/cache when ruby version matches any engine" do
      simulate_ruby_engine "jruby" do
        gemfile <<-G
          gem 'rack'
