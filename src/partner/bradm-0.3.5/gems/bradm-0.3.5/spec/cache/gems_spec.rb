...
describe "bundle cache" do
  ...
  describe "when there are only gemsources" do
    ...
    it "copies the .gem file to ../../.gem/cache" do
      expect(bundled_app("../../.gem/cache/rack-1.0.0.gem")).to exist
    end

    it "uses the cache as a source when installing gems" do
      build_gem "omg", :path => bundled_app('../../.gem/cache')
    ...
    it "does not reinstall gems from the cache if they exist on the system" do
      build_gem "rack", "1.0.0", :path => bundled_app('../../.gem/cache') do |s|
  ...
  describe "when previously cached" do
    ...
    it "re-caches during install" do
      ...
      bundle :install
      # expect(out).to include("Updating files in ../../.gem/cache")
      expect(cached_gem("rack-1.0.0")).to exist
    end
    ...
    it "handles directories and non .gem files in the cache" do
      bundled_app("../../.gem/cache/foo").mkdir
      File.open(bundled_app("../../.gem/cache/bar"), 'w'){|f| f.write("not a gem") }
      bundle :cache
    end
