...
%w(cache package).each do |cmd|
  describe "bundle #{cmd} with git" do
    it "copies repository to .gem cache and uses it" do
      git = build_git "foo"
      ...
      bundle "#{cmd} --all"
      expect(bundled_app("../../.gem/cache/foo-1.0-#{ref}")).to exist
      expect(bundled_app("../../.gem/cache/foo-1.0-#{ref}/.git")).not_to exist
      expect(bundled_app("../../.gem/cache/foo-1.0-#{ref}/../../.gem/deploycache")).to be_file

      FileUtils.rm_rf lib_path("foo-1.0")
      should_be_installed "foo 1.0"
    end

    it "copies repository to .gem cache and uses it even when installed with bundle --path" do
      git = build_git "foo"
      ref = git.ref_for("master", 11)
    ...
    it "tracks updates" do
      ...
      expect(bundled_app("../../.gem/cache/foo-1.0-#{ref}")).to exist
      expect(bundled_app("../../.gem/cache/foo-1.0-#{old_ref}")).not_to exist
    ...
    it "uses the local repository to generate the cache" do
      ...
      expect(bundled_app("../../.gem/cache/foo-invalid-#{ref}")).to exist
    ...
    it "copies repository to .gem cache, including submodules" do
      ...
      expect(bundled_app("../../.gem/cache/has_submodule-1.0-#{ref}")).to exist
      expect(bundled_app("../../.gem/cache/has_submodule-1.0-#{ref}/submodule-1.0")).to exist
    ...
    it "caches pre-evaluated gemspecs" do
      ...
      ref = git.ref_for("master", 11)
      gemspec = bundled_app("../../.gem/cache/foo-1.0-#{ref}/foo.gemspec").read
