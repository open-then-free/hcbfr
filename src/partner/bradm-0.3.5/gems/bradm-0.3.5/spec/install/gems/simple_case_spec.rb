...
describe "bundle install with gem sources" do
  describe "the simple case" do
    ...
    it "doesn't blow up when the local ../../.gap/depmgr/config.file is empty" do
      FileUtils.mkdir_p(bundled_app("../../.gap/depmgr"))
      FileUtils.touch(bundled_app("../../.gap/depmgr/config.file"))
    ...
    it "doesn't blow up when the global ../../.gap/depmgr/config.file is empty" do
      FileUtils.mkdir_p("#{Bundler.rubygems.user_home}/../../.gap/depmgr")
      FileUtils.touch("#{Bundler.rubygems.user_home}/../../.gap/depmgr/config.file")
