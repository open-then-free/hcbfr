...
describe "post bundle message" do
  ...
  # let(:bundle_deployment_message) {"It was installed into ./.gem"}
  ...
  describe "for fresh bundle install" do
    ...
    describe "with --path and" do
      ...
      it "with --without one group" do
        bundle "install --without emo --path .gem"
        expect(out).to include(bundle_deployment_message)
        expect(out).to include("Gems in the group emo were not installed")
        expect(out).to include(bundle_complete_message)
      end
      ...
      it "with --without two groups" do
        bundle "install --without emo test --path .gem"
        expect(out).to include(bundle_deployment_message)
        expect(out).to include("Gems in the groups emo and test were not installed")
        expect(out).to include(bundle_complete_message)
      end
      ...
      it "with --without more groups" do
        bundle "install --without emo obama test --path .gem"
        expect(out).to include(bundle_deployment_message)
        expect(out).to include("Gems in the groups emo, obama and test were not installed")
        expect(out).to include(bundle_complete_message)
      end
